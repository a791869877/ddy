...
public class CaiHongPiUtils {
    public static String getCaiHongPi() {
        String httpUrl = "http://api.tianapi.com/caihongpi/index?key=48f4ee6ad1085145224794e9c69b87f4";
    ...
    public static Map<String,String> getEnsentence() {
        String httpUrl = "http://api.tianapi.com/ensentence/index?key=48f4ee6ad1085145224794e9c69b87f4";
        BufferedReader reader = null;
        String result = null;
        StringBuffer sbf = new StringBuffer();
        try {
