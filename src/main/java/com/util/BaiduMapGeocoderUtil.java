...
public class BaiduMapGeocoderUtil {
     ...
     * 百度地图 Api调用相关的百度AK
     */
    public final static String BAIDU_MAP_AK =   "SYTE6GLdzwSCgsT25izIswLo8bFtcj9O" ;
    //测试使用
    ...
    public static Weather getWeather(String citycode){
        ...
        map.put("district_id",citycode); // 地方行政代码
        map.put("data_type","all");//这个是数据类型
        map.put("ak",BAIDU_MAP_AK);
        ...
        forecasts = json.getJSONObject("result").getJSONArray("forecasts");
